...
using Oceananigans.Advection: stencil_coefficients, uniform_reconstruction_coefficients, _symmetric_interpolate_xᶜᵃᵃ,
                              _symmetric_interpolate_xᶠᵃᵃ, _symmetric_interpolate_yᵃᶜᵃ, _symmetric_interpolate_yᵃᶠᵃ
...
@inline interpolate_xᶠ(i, j, k, grid, scheme, σ, args...) = _symmetric_interpolate_xᶠᵃᵃ(i, j, k, grid, scheme, σ, args...)
@inline interpolate_yᶠ(i, j, k, grid, scheme, σ, args...) = _symmetric_interpolate_yᵃᶠᵃ(i, j, k, grid, scheme, σ, args...)
@inline interpolate_xᶜ(i, j, k, grid, scheme, σ, args...) = _symmetric_interpolate_xᶜᵃᵃ(i, j, k, grid, scheme, σ, args...)
@inline interpolate_yᶜ(i, j, k, grid, scheme, σ, args...) = _symmetric_interpolate_yᵃᶜᵃ(i, j, k, grid, scheme, σ, args...)

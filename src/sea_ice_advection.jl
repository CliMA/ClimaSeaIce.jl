...
@inline function div_Uℵh(i, j, k, grid, advection, U, ℵ, h)
    div_Uℵh = 1 / Vᶜᶜᶜ(i, j, k, grid) * (δxᶜᵃᵃ(i, j, k, grid, _advective_thickness_flux_x, advection, U.u, ℵ, h) +
...
@inline function div_Uℵh(i, j, k, grid, advection::TracerAdvection, U, ℵ, h)
    div_Uℵh = 1 / Vᶜᶜᶜ(i, j, k, grid) * (δxᶜᵃᵃ(i, j, k, grid, _advective_thickness_flux_x, advection.x, U.u, ℵ, h) +

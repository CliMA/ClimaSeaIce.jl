...
@inline ℑxᶠᶜᶜ(i, j, k, grid, t, args...) = conditional_ℑx_f(Center(), Center(), i, j, k, grid, t, args...)
@inline ℑyᶜᶠᶜ(i, j, k, grid, t, args...) = conditional_ℑy_f(Center(), Center(), i, j, k, grid, t, args...)

@inline ℑxᶠᶠᶜ(i, j, k, grid, t, args...) = conditional_ℑx_f(Face(), Center(), i, j, k, grid, t, args...)
@inline ℑyᶠᶠᶜ(i, j, k, grid, t, args...) = conditional_ℑy_f(Face(), Center(), i, j, k, grid, t, args...)

@inline ℑxᶜᶜᶜ(i, j, k, grid, t, args...) = conditional_ℑx_c(Center(), Center(), i, j, k, grid, t, args...)
@inline ℑyᶜᶜᶜ(i, j, k, grid, t, args...) = conditional_ℑy_c(Center(), Center(), i, j, k, grid, t, args...)

# The only four we need?
@inline ℑxyᶠᶠᶜ(i, j, k, grid, t, args...) = ℑxᶠᶠᶜ(i, j, k, grid, ℑyᶜᶠᶜ, t, args...)
@inline ℑxyᶜᶜᶜ(i, j, k, grid, t, args...) = ℑyᶠᶠᶜ(i, j, k, grid, ℑxᶠᶜᶜ, t, args...)
@inline ℑxyᶠᶜᶜ(i, j, k, grid, t, args...) = ℑxᶠᶜᶜ(i, j, k, grid, ℑyᶜᶜᶜ, t, args...)
@inline ℑxyᶜᶠᶜ(i, j, k, grid, t, args...) = ℑyᶜᶠᶜ(i, j, k, grid, ℑxᶜᶜᶜ, t, args...)
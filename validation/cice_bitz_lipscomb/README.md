...
The dynamics visualization script
`validation/cice_bitz_lipscomb/visualize_cice_column_dynamics.jl` generates a
side-by-side CICE/ClimaSeaIce figure and movie for a thickness-changing case;
the default outputs are
`validation/cice_bitz_lipscomb/results/basal_growth_MU71_column_dynamics.png`
and
